VkResult createExternalImage(
    ...
    // Get function pointer for Vulkan 1.1 function
    ...
    if (!pvkGetPhysicalDeviceImageFormatProperties2) {
        printf("Failed to get vkGetPhysicalDeviceImageFormatProperties2 function pointer\n");
    ...
    VkResult result = pvkGetPhysicalDeviceImageFormatProperties2(
        physicalDevice,
        &formatInfo,
        &formatProps
    );
